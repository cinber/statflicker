...
sns.catplot(x='week', y="points", hue="manager_name", data=df_league, kind="swarm")
...
sns.lineplot(x="week", y="points", hue="manager_name", data=div1)
plt.legend(bbox_to_anchor=(1.05, 1), loc=2, borderaxespad=0.)
...
sns.lineplot(x="week", y="points", hue="manager_name", data=div2)
plt.legend(bbox_to_anchor=(1.05, 1), loc=2, borderaxespad=0.)
